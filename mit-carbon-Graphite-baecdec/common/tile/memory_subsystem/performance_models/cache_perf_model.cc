...
{ 
   ...
   _uncompress_cycles = 5;
   _wuncompress_cycles = 1;
   
   _uncompress_latency = Time(Latency(_uncompress_cycles,frequency));
   _wuncompress_latency = Time(Latency(_wuncompress_cycles,frequency));
