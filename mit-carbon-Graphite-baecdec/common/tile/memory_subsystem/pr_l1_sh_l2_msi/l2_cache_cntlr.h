...
namespace PrL1ShL2MSI
{
   ...
   public:
      ...
      CompressedCache* getL2Cache() { return _L2_cache; }
   ...
   private:
      ...
      static UInt32 _comp_cntr; //////////////////////////////////

      // L2 cache operations
      void getCacheLineInfo(IntPtr address, ShL2CacheLineInfo* L2_cache_line_info,
                            ShmemMsg::Type shmem_msg_type, bool update_miss_counters = false,/*ShememMsg::*/ShmemMsg* shmem_msg = NULL);
      ...
      void allocateCacheLine(IntPtr address, ShL2CacheLineInfo* L2_cache_line_info,/*ShememMsg::*/ShmemMsg* shmem_msg);
