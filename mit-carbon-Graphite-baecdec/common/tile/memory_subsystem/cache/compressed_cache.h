...
//#include "../pr_l1_sh_l2_msi/l2_cache_replacement_policy.h"
// Forwards Decls
...
public:
   ...
   void insertCacheLine(IntPtr inserted_address, CacheLineInfo* inserted_cache_line_info, Byte* fill_buf,
                        int* eviction, IntPtr* evicted_address1,IntPtr* evicted_address2 ,CacheLineInfo* evicted_cache_line_info1, CacheLineInfo* evicted_cache_line_info2,Byte* writeback_buf1,Byte* writeback_buf2,/*ShememMsg::*/PrL1ShL2MSI:: ShmemMsg* shmem_msg);
...
private:
   ...
   CompressedCacheSet** _sets;  // using compressing cache
   ...
   // Utilities
   CompressedCacheSet* getSet(IntPtr address) const;
